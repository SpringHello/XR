...
const Buy = () =>
import
('@/components/App/buy/Buy')
const BHost = () =>
import
('@/components/App/buy/BHost')
const BIP = () =>
import
('@/components/App/buy/BIP')
const BDisk = () =>
import
('@/components/App/buy/BDisk')
const BData = () =>
import
('@/components/App/buy/BData')
const BGpu = () =>
import
('@/components/App/buy/BGpu')
const Ecs = () =>
import
...
>>>>>>> e57e72ec519a850704e0f74ec342dc2f55e26527
...
const SceneInfo = () =>
import
('@/components/App/SceneInfo')
const SceneList = () =>
import
('@/components/App/SceneList')
...
const objStorageActive = () =>
import
('@/components/App/active/objStorageActive')
...
const DBActive = () =>
import
('@/components/App/active/DatabaseActive')

const EastSouthNode = () =>
import
('@/components/App/active/EastSouthNode')

//域名页面路由
const Domainname = () =>
import
('@/components/App/Domain/Domainname')
const DomainResult = () =>
import
('@/components/App/Domain/DomainResult')
...
const PobjectStorage = () =>
import
('@/components/App/product/ObjectStorage.vue')
const Pgpu = () =>
import
('@/components/App/product/Pgpu.vue')
// 登录注册页面
...
const GpuList = () =>
import
('@/components/Back/GpuList')
const Mirror = () =>
import
('@/components/Back/Mirror')
const SSHSecretKey = () =>
import
('@/components/Back/SSHSecretKey')
const Snapshot = () =>
import
...
const gpuManage = () =>
import
('@/components/Back/gpuManage')
const gpuUpLevel = () =>
import
('@/components/Back/gpuUpLevel')
