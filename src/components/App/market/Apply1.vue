  ...
  <div id="apply">
    ...
    <div class="flow">
      <div class="flow-box">
        ...
        <div class="flow-box-tooltip" style="display: none;">
    ...
    <div class="info">
      <div class="info-box">
        <div class="info-box-title"><span></span>公司基础信息</div>
        <!--公司基础信息-->
        ...
        <!--测试部署-->
        <div class="ino-box-deploy" style="display: none;">
          ...
          <div class="ino-box-deploy-item">
            ...
            <div class="content">
              <Select v-model="vpc" style="width:300px;margin-right: 20px;" placeholder="默认VPC">
...
export default {
  data () {
    return {
      ...
      // 规格
      sysIndex: false,
      sys: ['1核1G 40G SSD系统盘', '2核4G 40G SSD系统盘'],
      // 区域
      areaIndex: false,
      area: [],
      // 选择器
  ...
  methods: {
      ...
      this.$refs[name].validate((valid) => {
        if (valid) {
          ...
          axios.post('cloudMarket/insertServiceProvider.do', {
            merchan_name: this.formValidate.company,
            merchan_website: this.formValidate.web,
            merchan_desc: this.formValidate.desc,
            merchan_product_presentation: this.formValidate.intro,
            merchan_contact: this.formValidate.name,
            merchan_phone: this.formValidate.tel
          }).then(res => {
            if (res.status === 200 && res.data.status ===1) {
              sessionStorage.setItem('id', res.data.result)
            }
          })
        } else {
          // console.log('失败')
    ...
    changeArea (item,index) {
      ...
      console.log(this.mainframe.area)
