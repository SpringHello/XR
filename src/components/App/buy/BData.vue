      ...
      <div style="padding:40px;">
        ...
        <div style="border-bottom: 1px solid #D9D9D9;">
          ...
          <div class="item-wrapper">
            <div v-for="item in zoneList" :key="item.zoneid" v-if="item.zoneid !== '3205dbc5-2cba-4d16-b3f5-9229d2cfd46c'&&item.zoneid !== '3f3b1961-c693-489f-b6fc-c3ddc19d5c18'" class="zoneItem"
