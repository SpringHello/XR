      ...
      <div class="activity-rule">
        ...
        <div class="center">
          <div class="rules">
            ...
            <p>2. 新用户注册即可领取38元无门槛券，可用于官网任何产品（不包括域名产品、SSL证书产品），包括实时计费和包年包月。但不可用于一些超低折扣产品及特殊说明不可使用优惠券的产品。</p>
            <p>3. 同时注册完成账户可立即获得158元现金红包，可到“费用中心”-“我的卡券”查看。代金券包含68元优惠券（满88元可用，有效期三个月），90元优惠券（满150可用，有效期六个月）不可用于域名产品、SSL证书产品。</p>
