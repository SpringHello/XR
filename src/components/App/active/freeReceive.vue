    ...
    <div class="center">
      <div class="fr-rule">
        ...
        <dl>
          ...
          <dd>活动细则：</dd>
          <dt>ECS弹性云服务器免费试用需充值对应的押金后才可使用，领取后宽限期（主机领取后到开始使用）为<span>3</span>天，保留期（主机到期或者用户主动删除后回收站保留时间）为<span>7</span>天；主机未到期可自行删除，删除后或者主机使用到期后押金自动转到余额，可用于购买和续费；或者向客服申请退还余额，七个工作日即可到账。
          </dt>
