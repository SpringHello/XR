              ...
              <div class="w_host">
                <div v-for="(item,index) in cloudHost" :key="index">
                  <div class="host_title">
                    ...
                    <p style="font-size:14px;margin-top:21px;"><span style="font-size:20px">{{item.cpu}}核</span>CPU | <span style="font-size:20px">{{item.memory}}G</span>内存 ｜ <span
                      style="font-size:20px">{{item.rootDisk}}G</span>系统盘</p>
                  </div>
              ...
              <div class="w_host">
                <div v-for="(item,index) in gpuHost" :key="index">
                  <div class="gpu_title">
                    ...
                    <p style="font-size:14px;margin-top:15px;"><span style="font-size:20px">{{item.cpu}}核</span>vCPU | <span style="font-size:20px">{{item.memory}}G</span>内存 ｜
                      <span
                        style="font-size:20px">{{item.rootDisk}}G</span>系统盘</p>
              ...
              <div class="w_host">
                <div v-for="(item,index) in objectHost" :key="index">
                  <div class="host_title">
                    ...
                    <p style="font-size:14px;margin-top:21px;"><span style="font-size:20px">{{item.storage}}G</span>存储 | <span style="font-size:20px">{{item.flow}}G</span>内外网下载流量
                    </p>
                  </div>
                  <div class="host_content">
                    <div style="margin:10px 0;">
              ...
              <div class="w_host">
                <div v-for="(item,index) in cloudData" :key="index">
                  <div class="host_title">
                    ...
                    <p style="font-size:14px;margin-top:15px;"><span style="font-size:20px">{{item.cpu}}核</span>CPU | <span style="font-size:20px">{{item.memory}}G</span>内存 ｜ <span
                      style="font-size:20px">{{item.rootDisk}}G</span>系统盘</p>
                  </div>
                  <div class="host_content">
                    <div>
