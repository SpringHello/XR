    ...
    <div class="center-active box-g">
      <div class="wrap">
        <div class="content">
          ...
          <div class="box-wrap">
            <router-link v-for="(item,index) in activeData" :key="index" :class="{'box':true, graybox:!item.isStart}" :to="item.url" :style="{background:'url('+item.imgPath+')',backgroundRepeat:'no-repeat'}">
              <div class="box-head" :class="{textgray:item.bword}">
                <p>
                  {{item.name}}
                </p>
          ...
          <div class="box-wrap">
            <router-link v-for="(item,index) in onsaleData" :key="index" class="box" :to="item.url" :style="{background:'url('+item.imgPath+')',backgroundRepeat:'no-repeat'}">
              <div class="box-head">
                <p>
                  {{item.name}}
                </p>
    ...
    computed: {
      ...
      onsaleData() {
        var arry = this.activedata.filter(item =>{
          return item.onSales == true
        })
        return arry
      },
      activeData() {
        this.activedata[2].bword = true
        var arry = this.activedata.filter(item =>{
          return item.onSales == false
        })
        return arry
      }
    },
    ...
    .banner{
      ...
      .carousel {
        .carousel-item {
          ...
          .obj-storage {
            background:linear-gradient(90deg,rgba(255,227,208,1),rgba(255,255,255,1));
            height: 400px;
            position: relative;
            .wrap{
              position: relative;
