    ...
    .carousel {
      .carousel-item {
        ...
        .free-receive {
          height: 400px;
          background: #f56b23
            url("../../assets/img/active/freeToReceive/fr-banner1.png") center
            no-repeat;
        }
        .obj-storage {
        ...
        .groupBook {
          background: #fa846e
            url("../../assets/img/active/group-booking/gb-banner6.png")
            no-repeat center;
          height: 400px;
          > div {
            width: 1200px;
...
.center-active {
  background: url("../../assets/img/activecenter/bg-center.png") no-repeat
    center;
  background-size: cover;
  .box {
    &:hover {
