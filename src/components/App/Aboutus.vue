      ...
      <section style="background:#fff">
        <div class="section-wrap" style="width:1900px;">
          ...
          <div class="news">
            <div class="news-left">
              <p>
                新睿云是国家高新技术企业北京允睿讯通科技有限公司旗下的公有云平台。为客户提供云服务器、云存储、云网络、云数据库、云安全、云监控等产品的云服务提供商。我们的使命是:让云服务触手可及、简单易用，降低用户IT设施的建设和运维成本，助力企业数字化和面向互联网转型。新睿云通过先进的虚拟化技术将高性能服务器、高性能网络设备、高性能的全场景存储等资源进行虚拟化并形成庞大的资源池，同时通过高性能的云业务运营和管理平台对虚拟化资源进行统一分配、调度与管理，形成高效、稳定、可靠、安全的公有云产品体系，满足不同用户、不同场景对资源的个性化需求，有效降低用户整体的CAPEX和OPEX。
              </p>
            </div>
