    ...
    <div>
      ...
      <ol>
        ...
        <li>输入【Ping + 服务器公网 IP 地址】，回车。如：ping 139.199.XXX.XXX
          正常情况：<br>
          <img src="../../../../assets/img/doc/faq/faq-img1.png"> <br>
          异常情况：（网络连接问题）<br>
          <img src="../../../../assets/img/doc/faq/faq-img2.png">
        </li>
        <li>测试远程端口开启情况。输入【telnet + 服务器公网 IP 地址 + 端口号】，回车。如：telnet 139.199.XXX.XXX 。<br>
          <img src="../../../../assets/img/doc/faq/faq-img3.png">
          <p>正常情况：黑屏，仅显示光标。</p>
          <p>异常情况：连接失败，如下图：</p>
          <img src="../../../../assets/img/doc/faq/faq-img4.png">
        </li>
      ...
      <ol>
        ...
        <li>在云服务器中，右键单击【我的电脑】- 单击【属性】-【高级系统设置】-【远程】，在 “远程桌面”功能块中点选【允许远程连接带此计算机】，单击【确定】。<br>
          <img src="../../../../assets/img/doc/faq/faq-img5.png">
        </li>
      </ol>
      <h1>步骤三：检查远程桌面运行情况</h1>
      <ol>
        <li>登录云服务器，单击【开始】，单击【搜索(图标)】，输入【 cmd 】，回车打开管理员命令框。<br>
          <img src="../../../../assets/img/doc/faq/faq-img6.png">
        </li>
        <li>执行命令netstat -ant | findstr 3389（默认情况下远程桌面服务端口号为 3389 ）：
          正常情况 <br>
          <img src="../../../../assets/img/doc/faq/faq-img7.png"><br>
          <p>异常情况：不显示任何连接。</p>
      ...
      <ol>
        ...
        <li>
          ...
          <img src="../../../../assets/img/doc/faq/faq-img8.png"><br>
        </li>
      </ol>
      <h1>步骤五：检查远程端口</h1>
      ...
      <ol>
        ...
        <li>依据左侧目录导航，依次打开目的地址：
          ...
          <img src="../../../../assets/img/doc/faq/faq-img9.png"><br>
        </li>
        ...
        <li>再依据左侧目录导航，依次打开目的地址：
          ...
          <img src="../../../../assets/img/doc/faq/faq-img10.png"><br>
        </li>
      ...
      <ol>
        ...
        <li>点选 “十进制” ，将端口修改成 0~65535 之间未被占用端口即可。<br>
          <img src="../../../../assets/img/doc/faq/faq-img11.png"><br>
        </li>
