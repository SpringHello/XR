      ...
      <div class="universal-modal-content-flex">
        <div class="rules">
          <div class="rulesContent">
            ...
            <p>6.1.7 若甲方存在上述6.1.1～6.1.6条约定的任一情形的，乙方有权按相关规定删除信息、暂停或终止提供云业务服务，并有权冻结或注销您账户部分或全部功能，包括但不限于帐户被限制资金转出功能、押金提现、退款等。</p>
            <p>6.2本服务使用过程中，对于甲方自行提供并使用的软件，甲方应保证该等软件的合法性和不侵权。如任何第三方主张甲方所使用软件侵犯其所有权或者知识产权等合法权益，甲方
              应负责解决，并赔偿乙方就此而承担的一切费用和损失。</p>
            <p>6.3 甲方使用云业务服务所引起的一切后果由甲方承担。如因甲方使用云业务服务中所涉行为或内容不合法或侵权而导致乙方承担责任或对乙方造成损失的，甲方应负责解决，并赔偿乙方由此遭受的全部损失；同时您的新睿云账户（全部或部分权限或功能）将被冻结包括但不限于帐户被限制资金转出功能、押金提现、退款等。</p>
            <p>6.4 您理解并同意，如果您拒绝如实提供身份证明及相关资料，或未能通过新睿云审核，新睿云有权长期冻结该等账户且长期限制账户部分或全部功能，包括但不限于资金转出功能、押金提现、退款等。</p>
            ...
            <p style="text-indent:0em">九、若违反本承诺书有关条款和国家相关法律法规的，甲方直接承担相应法律责任，造成财产损失的，由甲方直接赔偿。同时，乙方有权按相关规定删除信息、暂停或终止提供云业务服务，并有权冻结或注销您账户部分或全部功能，包括但不限于帐户被限制资金转出功能、押金提现、退款等。</p>
