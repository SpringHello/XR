          ...
          <div class="body">
            <form>
              ...
              <div style="position:relative">
                ...
                <img :src="imgSrc"
                     @click="imgSrc=`http://zschj.xrcloud.net/ruicloud/user/getKaptchaImage.do?t=${new Date().getTime()}`">
              </div>
            </form>
          </div>
          <div class="foot">
  ...
  export default{
    ...
    data(){
      return {
        ...
        /* 验证码地址(加上时间戳，防止缓存) */
        imgSrc: `http://zschj.xrcloud.net/ruicloud/user/getKaptchaImage.do?t=${new Date().getTime()}`,
        activeBanner: 1,
      }
    },
    created(){
        ...
        axios.get('user/login.do', {
          ...
          if (response.status == 200 && response.statusText == 'OK') {
            if (response.data.status == 1) {
              ...
              this.imgSrc = `http://zschj.xrcloud.net/ruicloud/user/getKaptchaImage.do?t=${new Date().getTime()}`
