    ...
    methods: {
      ...
      SlideVerify(path, num) {
        ...
        btn.onmousedown = function (e) {
          ...
          //加载图片小块
          var ry = Math.floor(Math.random() * 80) + 20;
          var rx = Math.floor(Math.random() * 150) + 110;
          //chip.style.background = 'url(' + path + imgAt + '.jpg)';
          chip.style.background = 'url(' + require('../../assets/img/imgValidation/1.jpg') + ')'
          ...
          chip2.style.background = 'url(' + require('../../assets/img/imgValidation/1.jpg') + ')'
