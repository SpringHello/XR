			...
			<div class="content" v-if="selectedTabSec == 'content'" style="min-height: 665px;">
				...
				<div style="margin-left: 20px;margin-top: 150px;">
					...
					<RadioGroup vertical v-model="vertical" style="margin-left: 15px;margin-top: -3px;">
						...
						<Radio label="l2" :disabled="disabled12">其他金额<InputNumber id="idinputnum1" :disabled="disabled11" :max="moneysure"
							 :min="1" v-model="Otheramount" @on-change="Otheramountg"></InputNumber><span id="idspan1">元</span></Radio>
					</RadioGroup>
				</div>
