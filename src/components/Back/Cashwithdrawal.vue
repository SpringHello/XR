					...
					<div class="remindbox-right">
						<div class="right">
							<span style="line-height: 21px;margin-top: 5px;"><span style="line-height: 21px;">申请线上提现后您的款项将在</span><span
								...
								<a @click="$router.push('/documentInfo/6bSa9TMxO/6zxZtv8QU')" style="color: #2A99F2;text-decoration: underline;">自助提现常见问题</a></span>
							<div class="following">
								...
								<span>4、通过线下打款进账的现金充值金额提现方式请 <a @click="$router.push('/documentInfo/6bSa9TMxO/6zxagA7H2')" id="aself1">点击这里查看</a></span>
			...
			<Modal v-model="showModal.Cashconfirmation" :scrollable="true" :closable="false" :width="390">
				...
				<div class="modal-content-s" style="width: 101%;">
					<div>
						...
						<p class="lh24" style="margin-top: 10px;">若您的线下汇款（对公转账）金额需要提现，请点击查看 <a @click="$router.push('/documentInfo/6bSa9TMxO/6zxagA7H2')"
