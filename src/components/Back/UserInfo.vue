    ...
    @click="notAuth.currentStep=notAuth.allStep.selectAuthType">重新选择</span></span>
          ...
          <Tab-pane label="企业认证" name="companyInfo">
            ...
            <div v-if="authInfo&&authInfo.authtype!=0&&authInfo.checkstatus==0" class="companyAuthInfo">
              <ol>
                <li><span>公司名称</span><span>北京允睿讯通科技有限公司</span><span>企业认证</span></li>
                <li><span>所属行业</span><span>金融</span></li>
                <li><span>企业联系电话</span><span>300281013</span></li>
                <li><span>营业执照号</span><span>111111111111111111111</span></li>
                <li><span>企业法人姓名</span><span>虾酱</span></li>
                <li><span>企业法人身份证号</span><span>676767676767676676767</span></li>
                <li><span>经办人姓名</span><span>张三</span></li>
                <li><span>经办人联系电话</span><span>13676867678</span></li>
                <li><span>经办人身份证号</span><span>13676867678</span></li>
              </ol>
            </div>
            <div v-if="(authInfo&&authInfo.authtype!=0&&authInfo.checkstatus==2) || (authInfo&&authInfo.authtype!=0&&authInfo.checkstatus==1)" style="padding: 20px 0 0 170px;">
