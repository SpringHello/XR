        ...
        <Tabs type="card" :animated="false" style="margin-top:20px;">
          <TabPane label="启动配置">
            <div>
              ...
              <a href="https://www.xrcloud.net/documentInfo/wHfINiD0y/wHy9ceWfZ" style="float: right;line-height: 30px;" target="_blank">查看帮助文档</a>
          ...
          <TabPane :label="Groups">
            <div>
              ...
              <a href="https://www.xrcloud.net/documentInfo/wHfINiD0y/wZvPELK4R" style="float: right;line-height: 30px;" target="_blank">查看帮助文档</a>
